...
%global pkg_name ign_ros2_control_demos
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-humble-ign-ros2-control-demos
Version:        0.7.21
Release:        1%{?dist}
...
%changelog
* Mon Aug 31 2026 Alejandro Hernandez <ahcorde@osrfoundation.org> - 0.7.21-1
- Autogenerated by Bloom

* Wed May 13 2026 Alejandro Hernandez <ahcorde@osrfoundation.org> - 0.7.20-1
- Autogenerated by Bloom
